        ...
        return AnimatedBuilder(
          ...
          builder: (context, child) {
            return CustomPaint(
              ...
              child: AnimatedPlaceTimeline(num: widget.num),
            );
          },
        );
      },
...
class _AnimatedPlaceTimelineState extends State<AnimatedPlaceTimeline>
  ...
  void didUpdateWidget(covariant AnimatedPlaceTimeline oldWidget) {
    ...
    if (oldWidget.num != widget.num) {
      ...
      markerAnimations = controllers.map((controller) {
        return Tween<Offset>(
          begin: const Offset(0, -0.3),
          end: Offset.zero,
        ).animate(CurvedAnimation(parent: controller, curve: Curves.easeOut));
                  ...
                  children: [
                    ...
                    FadeTransition(
                      ...
                      child: Padding(
                        ...
                        child: PinMarker(imagePath: 'assets/images/sea.jpg'),
                      ),
                    ),
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              ...
              onTap: () async {
                ...
                await Get.to(() => MapPage(initialKeyword: keyword.isEmpty ? null : keyword));
